...
echo ""
echo "\033[33mhttp http://quotesvc.local.pcfdev.io/random\033[0m"
http http://quotesvc.local.pcfdev.io/random
read -p "Press ENTER to continue..."
echo ""
...
echo ""
echo "\033[33mhttp http://quotesvc.local.pcfdev.io/random x 4\033[0m"
http http://quotesvc.local.pcfdev.io/random
http http://quotesvc.local.pcfdev.io/random
http http://quotesvc.local.pcfdev.io/random
http http://quotesvc.local.pcfdev.io/random
