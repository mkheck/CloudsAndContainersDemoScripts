...
echo ""
#new code, 3/31/17
echo "\033[33mdocker-machine scp ~/Projects/CloudsAndContainersDemoscripts/docker-compose.yml mgr1:/home/docker/.\033[0m"
docker-machine scp ~/Projects/CloudsAndContainersDemoScripts/docker-compose.yml mgr1:/home/docker/.
echo "\033[33mdocker-machine ssh mgr1 docker stack deploy --compose-file ~/Projects/CloudsAndContainersDemoScripts/docker-compose.yml quotesvc\033[0m"
docker-machine ssh mgr1 docker stack deploy --compose-file ~/Projects/CloudsAndContainersDemoScripts/docker-compose.yml quotesvc
echo "\033[33mdocker-machine ssh mgr1 docker stack services quotesvc\033[0m"
docker-machine ssh mgr1 docker stack services quotesvc
#echo "\033[33mdocker service create --replicas 1 -p 8088:8088 --name quotesvc hecklerm/quotesvc\033[0m"
#docker-machine ssh mgr1 docker service create --replicas 1 -p 8088:8088 --name quotesvc hecklerm/quotesvc
#end new code, 3/31/17
echo ""
